...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-N2JM0CV;Database=AirplaneSystem;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Airplane>(entity =>
        {
            entity.HasKey(e => e.AirplaneId).HasName("PK__Airplane__5ED76B850F80673B");
        ...
        {
            entity.HasKey(e => e.FlightId).HasName("PK__Flight__8A9E148E092A2DAB");
        ...
        {
            entity.HasKey(e => e.PassengerId).HasName("PK__Passenge__88915F90BF7BCCE6");
        ...
        {
            entity.HasKey(e => e.PilotId).HasName("PK__Pilot__B305516DBB24F90B");
        ...
        {
            entity.HasKey(e => e.ReservationId).HasName("PK__Reservat__B7EE5F046B28050C");
